...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Vote'
        db.create_table('lbforum_vote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lbforum.Post'])),
            ('value', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('lbforum', ['Vote'])

        # Adding field 'Post.value'
        db.add_column('lbforum_post', 'value',
    ...
    def backwards(self, orm):
        # Deleting model 'Vote'
        db.delete_table('lbforum_vote')

        # Deleting field 'Post.value'
        db.delete_column('lbforum_post', 'value')
    ...
    models = {
        ...
        'lbforum.vote': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lbforum.Post']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'value': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        }
    }
